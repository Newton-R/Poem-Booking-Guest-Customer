...
export const SessionExpirationModal = () => {
  ...
  return (
    <div className="fixed top-0  left-0 z-90 w-full min-h-screen bg-black/50 backdrop-blur-xs flex items-center justify-center">
      <div className="flex flex-col gap-2 p-6 w-[98%] max-w-md rounded-xl bg-white items-center text-center justify-center">
